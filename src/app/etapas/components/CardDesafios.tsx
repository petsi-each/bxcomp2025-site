...
export default function CardDesafios(props: DesafioList) {
    ...
    return (
        <div>
            <div className="flex flex-wrap justify-center  w-dvw md:w-[1000px] gap-5">
                {
                    props.desafios.map((desafioObj, idx) => (
                        <article key={idx} className={`flex flex-col justify-evenly px-16 py-6 w-[350px] md:w-[450px] h-auto bg-amarelo rounded-[1vw] text-center text-pretoBX hover:transition-all hover:duration-150 hover:ring-8 hover:ring-azulelegante`}>
