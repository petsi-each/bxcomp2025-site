            ...
            <div className="flex flex-wrap justify-center w-full gap-5">
                {
                    props.desafios.map((desafioObj, idx) => (
                        <article key={idx} className={`flex flex-col cursor-pointer justify-evenly px-16 py-6 w-[315px] [@media(min-width:420px)]:w-[410px] min-h-[215px] h-[auto] bg-amarelo rounded-[1vw] text-center text-pretoBX hover:transition-all hover:duration-150 hover:ring-8 hover:ring-azulelegante`}>
